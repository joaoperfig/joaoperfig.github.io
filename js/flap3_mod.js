var __extends = this && this.__extends || function() {
	...
	Engine = function(a) {
		function b(c) {
			function d(a) {
				a.x < -a.topObstacle.width ? (a.reposition(a.previousObstacle.x + a.previousObstacle.topObstacle.width + c.rnd.integerInRange(X, W), c.rnd.integerInRange(T + .5 * A, O - T - .5 * A), S, A), G.alive || G.isActive || (G.reposition(a.x + .5 * X, c.rnd.integerInRange(G.height, O - G.height)), (G.y <= a.y - .5 * A || G.y >= a.y + .5 * A) && (G.x += a.width >> 1))) : a.hasScore || (a.x + a.topObstacle.width <= F.x ? (a.hasScore = !0, r += 5, M || (null != c.options.callback && null != c.options.callback.updateScore ? c.options.callback.updateScore(r) : "function" == typeof updateScore && updateScore(r)), u++, u > 3 && (u = 0, v++, 20 > w && (w += .5, C.setSpeed(w)), A > V && (A -= U))) : !G.isActive && a.x < F.x + F.midW && (o(a, C.aZonesTop, a.topObstacle) || o(a, C.aZonesBottom, a.bottomObstacle)) && (R ? m() : F.x -= 2 * w))
			}
